...
def main():
    ...
    with app.app_context():
        ...
        reservations_to_create = [
            {
                ...
                'state': 'Pendiente',
                'days_ago': 0,  # Hoy
                'hours_offset': 2,  # Creada hace 2 horas, expira en 22 horas
            ...
            },
            {
                ...
                'state': 'Pendiente',
                'days_ago': 0,  # Hoy
                'hours_offset': 8,  # Creada hace 8 horas, expira en 16 horas
            ...
            },
            {
                ...
                'state': 'Aprobada',
                'days_ago': 1,  # Ayer
                'hours_offset': 0,  # Creada ayer a esta hora, aún no expira
            ...
            },
            {
                ...
                'days_ago': 3,
                'hours_offset': 0,
                'notes': "Reserva que no fue procesada a tiempo"
            },
        ]
        ...
        for idx, reservation_data in enumerate(reservations_to_create, 1):
            try:
                ...
                created_at = datetime.utcnow() - timedelta(
                    days=reservation_data['days_ago'],
                    hours=reservation_data.get('hours_offset', 0)
                )
                
                # Expiración solo para Pendiente y Aprobada
                if reservation_data['state'] in ['Pendiente', 'Aprobada']:
                    # Expira 24 horas después de created_at
        ...
        print(f"  • Expiradas: {sum(1 for r in reservations_to_create if r['state'] == 'Expirada')}")
        print()
